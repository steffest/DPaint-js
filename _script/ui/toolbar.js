...
let Toolbar = function(){
    ...
    let items=[
        ...
        {name: "pan", isTool: true,label: "H", command: COMMAND.PAN, info: "<b>H</b> or <b>Space</b> Pan the image."},
        {name: "picker",label: "I", isTool: true, command: COMMAND.COLORPICKER, info: "<b>I</b> or <b>Shift+Draw</b> Pick color from image."},
