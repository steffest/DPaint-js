...
let Toolbar = function(){
    ...
    let items=[
        ...
        {name: "floodselect", isTool: true, command: COMMAND.FLOODSELECT, info: "<b>W</b> Make selection of an area of the same color."},
        ...
        {name: "spray", isTool: true, command: COMMAND.SPRAY, info: "<b>O</b>  Spray brush."},
